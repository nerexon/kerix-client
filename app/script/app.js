  ...
  data.server.categories.forEach((cat) => {
    ...
    headerEl.addEventListener("dragover", (e) => {
      if (draggingType === "category") {
        e.preventDefault();
        catEl.classList.add("over"); // apply to parent div
      }
    });
    headerEl.addEventListener("dragleave", () => {
      if (draggingType === "category") catEl.classList.remove("over"); // remove from parent
    });
    headerEl.addEventListener("drop", (e) => {
      if (draggingType === "category") {
        e.preventDefault();
        catEl.classList.remove("over"); // remove from parent
